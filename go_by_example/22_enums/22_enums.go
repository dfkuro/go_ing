...
// cases the stringer tool can be used in conjunction with go:generate
...
// transition emulates a state transition for a server; it takes
// the existing state and returns a new state.
