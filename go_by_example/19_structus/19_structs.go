...
// Go is a garbage collected language; you can safely return a pointer to a
// local variable - it will only be cleaned up by the garbage collector when
...
func main() {
	...
	// a name. The value can have an anonymous struct type. This technique is
